...
from miappe.metadata.isatools.model.mixins import StudyAssayMixin
from miappe.metadata.isatools.model.ontology_annotation import OntologyAnnotation
from miappe.metadata.isatools.model.datafile import DataFile
from miappe.metadata.isatools.model.material import Material
...
class Assay(Commentable, StudyAssayMixin, object):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.Assay(measurement_type={measurement_type}, " \
