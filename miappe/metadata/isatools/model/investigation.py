...
from miappe.metadata.isatools.model.mixins import MetadataMixin
from miappe.metadata.isatools.model.ontology_annotation import OntologySource
...
from miappe.metadata.isatools.model.loader_indexes import loader_states as indexes
from miappe.metadata.isatools.graphQL.models import IsaSchema
...
class Investigation(Commentable, MetadataMixin, Identifiable, object):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.Investigation(" \
