...
class FactorValue(Commentable):
    ...
    def __repr__(self):
        return ("miappe.metadata.isatools.model.FactorValue(factor_name={factor_name}, value={value}, unit={unit})"
...
class StudyFactor(Commentable, Identifiable):
    ...
    def __repr__(self):
        return ("miappe.metadata.isatools.model.StudyFactor(name='{study_factor.name}', "
