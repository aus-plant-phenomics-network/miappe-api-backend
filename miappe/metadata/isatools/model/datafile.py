from miappe.metadata.isatools.model.comments import Commentable
...
from miappe.metadata.isatools.model.identifiable import Identifiable
...
class DataFile(Commentable, ProcessSequenceNode, Identifiable):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.DataFile(filename='{data_file.filename}', " \
...
class RawDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.RawDataFile(filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
...
class DerivedDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.DerivedDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class RawSpectralDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.RawSpectralDataFile(filename='{0.filename}', " \
...
class DerivedArrayDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.DerivedArrayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class ArrayDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.ArrayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class DerivedSpectralDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.DerivedSpectralDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class ProteinAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.ProteinAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class PeptideAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.PeptideAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class DerivedArrayDataMatrixFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.DerivedArrayDataMatrixFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class PostTranslationalModificationAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.PostTranslationalModificationAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class AcquisitionParameterDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.AcquisitionParameterDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class FreeInductionDecayDataFile(DataFile):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.FreeInductionDecayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
