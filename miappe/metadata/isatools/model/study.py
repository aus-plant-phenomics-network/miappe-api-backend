...
from miappe.metadata.isatools.model.mixins import StudyAssayMixin, MetadataMixin
...
from miappe.metadata.isatools.model.factor_value import StudyFactor
...
class Study(Commentable, StudyAssayMixin, MetadataMixin, object):
    ...
    def __repr__(self):
        return "miappe.metadata.isatools.model.Study(filename='{study.filename}', " \
