...
from miappe.metadata.isatools.graphQL.custom_scalars import DateTime, StringOrInt
from miappe.metadata.isatools.graphQL.inputs import (
    AssayParameters,
...
from miappe.metadata.isatools.graphQL.utils.search import (
    search_assays,
...
class Process(ObjectType):
    from miappe.metadata.isatools.graphQL.unions import ProcessInputs, ProcessOutputs
