...
from miappe.metadata.isatools.model import Investigation
from miappe.metadata.isatools.isatab.defaults import _RX_I_FILE_NAME, log
from miappe.metadata.isatools.utils import utf8_text_file_open
from miappe.metadata.isatools.isatab.load import read_tfile
from miappe.metadata.isatools.isatab.dump.write import write_study_table_files, write_assay_table_files
from miappe.metadata.isatools.isatab.dump.utils import (
