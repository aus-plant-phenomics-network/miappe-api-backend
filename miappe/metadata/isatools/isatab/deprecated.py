...
miappe.metadata.isatools.model package.
"""
...
from miappe.metadata.isatools.isatab.defaults import _RX_COMMENT, log
from miappe.metadata.isatools.isatab.utils import find_lt, find_gt, get_squashed
from miappe.metadata.isatools.isatab.load import load, load_table
...
def isatab_get_data_files_list_command(input_path, output, json_query=None, galaxy_parameters_file=None):
    ...
    if data_files is None:
        raise RuntimeError("Error getting data files with miappe.metadata.isatools")
