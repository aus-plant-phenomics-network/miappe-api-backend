...
from miappe.metadata.isatools.create import errors
from miappe.metadata.isatools.create.constants import (
...
from miappe.metadata.isatools.utils import urlify, n_digits

log = logging.getLogger('miappe.metadata.isatools')
...
class Treatment(Element):
    ...
    def __init__(self, element_type=INTERVENTIONS['CHEMICAL'],
        ...
        :param factor_values: set of miappe.metadata.isatools.model.v1.FactorValue
        """
...
class ProtocolNode(SequenceNode, Protocol):
    """
    These class is a subclass of miappe.metadata.isatools.model.Protocol
...
class StudyDesign(object):
    """
    Top-level class for the miappe.metadata.isatools.create module, and the study design planning.
    ...
    def _generate_samples_and_assays(self, sources_map, sampling_protocol, performer):
        ...
        :param sampling_protocol: miappe.metadata.isatools.model.Protocol
        :param performer: str
        :return:
        """
    ...
    def generate_isa_study(self, identifier=None):
        ...
        :return: miappe.metadata.isatools.model.Study
        """
...
class TreatmentFactory(object):
    ...
    def add_factor_value(self, factor, factor_value):
        ...
        :param factor: miappe.metadata.isatools.model.StudyFactor
