from miappe.metadata.isatools.model import OntologyAnnotation, OntologySource, FactorValue, Characteristic
from miappe.metadata.isatools.create.model import StudyDesign, NonTreatment, Treatment, StudyCell, StudyArm, \
    SampleAndAssayPlan
...
def assay_template_to_ordered_dict(assay_template):
    ...
    deserializes a JSON plain dictionary into an OrderedDictionary to be consumed by
        miappe.metadata.isatools.create.models.AssayGraph.generate_assay_plan_from_dict() to generate a full AssayGraph
...
def assay_ordered_dict_to_template(assay_ord_dict):
    """
    Serializes an OrderedDict compatible with miappe.metadata.isatools.create.models.AssayGraph.generate_assay_plan_from_dict() into a
...
def _generate_element(datascriptor_element_dict):
    ...
    :return: miappe.metadata.isatools.create.models.Element
    """
...
def generate_study_design(datascriptor_study_config):
    ...
    :return: miappe.metadata.isatools.create.StudyDesign
    """
